...
function _buildModernReceiptPDF(doc, payment, tenant, property, currencyCtx) {
  ...
  const receiptFooter = `Generated by RentifyPro on ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}. System-generated receipt.`;
  doc.save()
...
function _buildClassicReceiptPDF(doc, payment, tenant, property, currencyCtx) {
  ...
  doc.save().font(FONT.regular).fontSize(7.5).fillColor(C.gray500)
    .text(`Generated by RentifyPro on ${fmt.date(new Date())}`, M, H - 50, { width: CW, align: 'center', lineBreak: false }).restore();
  doc.page.margins.bottom = savedBottomMargin;
}
...
function _buildMinimalistReceiptPDF(doc, payment, tenant, property, currencyCtx) {
  ...
  doc.save().font(FONT.regular).fontSize(7).fillColor(C.gray500)
    .text(`Generated by RentifyPro · ${fmt.date(new Date())}`, M, H - 50, { width: CW, align: 'center', lineBreak: false }).restore();
  doc.page.margins.bottom = savedBottomMargin;
}
...
function addClassicPageFurniture(doc, pageNum, totalPages, title = 'RENTAL AGREEMENT') {
  ...
  doc.page.margins.bottom = 0;
  doc.save().font(FONT.regular).fontSize(7).fillColor(C.gray500)
    .text('Generated by RentifyPro. Digital signatures are legally binding.', 0, PAGE.height - 24, { align: 'center', lineBreak: false, width: PAGE.width }).restore();
  doc.page.margins.bottom = savedBottomMargin;
  doc.y = savedY;
}
...
function addMinimalistPageFurniture(doc, pageNum, totalPages, agreementId) {
  ...
  doc.save().font(FONT.regular).fontSize(6.5).fillColor(C.gray500)
    .text('RentifyPro · Rental Agreement · Digital signatures are legally binding', 0, PAGE.height - 24, { align: 'center', lineBreak: false, width: PAGE.width }).restore();
  doc.page.margins.bottom = savedBottomMargin;
  doc.y = savedY;
}
...
function _buildMinimalistPDF(doc, agreement, landlord, tenant, property, currencyCtx) {
  ...
  doc.save().font(FONT.bold).fontSize(36).fillColor(C.gray900)
    .text('RentifyPro', PAGE.margin, y, { lineBreak: false }).restore();
  y += 46;
