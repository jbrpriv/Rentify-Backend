...
function buildVariableMap(agreement) {
  ...
  return {
    ...
    maintenance_fee_amount: _maintenanceStr,
    ...
    late_fee_grace_period: String(financials?.lateFeeGracePeriodDays ?? 5),
    start_date:        _fmt.date(term?.startDate),
    end_date:          _fmt.date(term?.endDate),
    duration_months:   _durationStr,
    utilities_included: agreement.utilitiesIncluded ? 'Utilities included' : 'Utilities not included',
    utilities:         agreement.utilitiesIncluded ? 'Utilities included' : 'Utilities not included',
    utilities_details: agreement.utilitiesDetails || '',
